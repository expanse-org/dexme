export default {
  ...
  version:{
    label:'Beta3',
    title:'Beta3',
    description:'EXPEX.IO (Expex2) is an open-sourced implementation of a web-based non-custodial Expanse wallet that enables users to trade ERC20 tokens using the Expexing Protocol. Before proceeding, you should review the codebase. Expex2 is a not-for-profit product, and the Expexing Foundation cannot take responsibility for any loss of your crypto-assets.',
    feedback:'Feedback',
  ...
  feedback:{
    ...
    email_subject:"Expex Wallet Feedback",
    email_body:`
## ISSUES \n
...
`,
  ...
  navbar: {
    ...
    refresh_page_tip_description:"Under the consideration of asset safety, Expex shall not keep any of your wallet information.",
  },
  order: {
    buy: 'Buy',
    sell: 'Sell',
    ...
    sign: "Sign",
    signed: "Signed Order",
    place_tip: "Order submission is free and does not cost Expanse",
  ...
  home: {
    title: 'Expex',
    subtitle: 'A non-custodial Expanseeum wallet and Expexing DEX.',
    beta_notification_title:'Can\'t wait to trade with Expexing?',
  ...
  txs: {
    ...
    type_others: 'Others',
    type_lrc_fee: 'PEX Fee',
    type_lrc_reward: 'PEX Reward',
    type_sell: 'Sell',
    type_buy: 'Buy',
    buy: "Buy",
  ...
  trade: {
    ...
    to_trade: "Trade",
    lrcFee_increased: "We need to increase your order's trading fee from {userSet}PEX to a minimum of {increased}PEX. Do you want to continue?",
    ...
    not_allow:"EXPEX.IO (Expex2) is still in its beta, please come back later when it's ready for more people to use.",
    ...
    ring: "Ring",
    tips_time_to_live: "Your order is valid for a specified period known as Time-To-Live (TTL) and will expire automatically. Use this value to avoid canceling orders explicitly to save yourself some Expanse. We recommend using amount between one hour and one day.",
    tips_lrc_fee: "The total fee in PEX to pay ring-miners to find counterparty orders that your order can trade with. The higher the fee is, the more likely and quicker your order will be matched and filled.",
    tips_margin_split: "If your account does not have enough PEX to pay miners, you can choose margin split to pay PEX Fee.</br>You can only choose either Margin Split or PEX Fee to pay the miners, so do not worry about double spending.</br>We do not recommend you modify this value unless you have fully understood its mechanism.",
    ...
    lrcfee_is_required:'PEX is required to pay trade fees, added on your history orders need PEX, totally required {required} PEX.',
    ...
    current_lrc_fee_ratio:'PEX Fee Ratio',
    current_lrc_fee: 'PEX Fee',
  ...
  token: {
    ...
    view_transaction: 'View Transaction on expanse.tech',
    send_again: 'Send Again',
    convert_again: 'Convert Again',
    ethereum_address: "My Expanse Address",
    copy: "Copy",
    ...
    transfer_result_etherscan: "View transaction on expanse.tech",
  ...
  wallet: {
    ...
    loopring_on: "Expexing token on  {project}",
    neo: "NEO",
    qtum: "QTUM",
    ...
    metamask_unlock_refresh_button: 'All Done? Refresh Expex',
    ...
    metamask_unlock_step_refresh_title:'Refresh Expex',
    metamask_unlock_step_refresh_content:'Refresh Expex wallet to enable MetaMask',
    ...
    backup: {
      ...
      backup_tip: 'Expex doesn\'t keep a copy of your privatekey, keystore file, or mnemonic words. Make sure you back up these information immediately.',
    ...
    unlocked_notification_content: 'Good job. Now you can experience the Expex wallet. Be sure to let us know your feedback.',
    ...
    unlock_by_cookie_address_notification:'Expex has switched your account to the watch-only mode, and your private-key is no longer available to the browser.  You\'ll need to unlock your wallet again to perform some operations.',
    ...
    metamask_installed_locked_content: 'We detected you have installed MetaMask browser extension and want to unlock Expex with it, please created or unlocked an account in MetaMask first, then try to unlock with MetaMask in Expex again',
  },
  demo:{
    badge_title:'Demo Wallet',
    badge_tip:'You are using a demo wallet in the watch-only mode',
    confirm_title: 'Try Expex with a demo wallet',
  ...
  ticket:{
    ...
    open_tip:'Only open to holder who have more than {amount} PEX',
