...
`,
  ...
  order: {
    ...
    sign: "Sign",
    signed: "Signed Order",
    place_tip: "Order submission is free and does not cost EXP",
  ...
  txs: {
    ...
    type_others: 'Others',
    type_pex_fee: 'PEX Fee',
    type_pex_reward: 'PEX Reward',
    type_sell: 'Sell',
    type_buy: 'Buy',
    buy: "Buy",
  ...
  trade: {
    ...
    to_trade: "Trade",
    pexFee_increased: "We need to increase your order's trading fee from {userSet}PEX to a minimum of {increased}PEX. Do you want to continue?",
    ...
    ring: "Ring",
    tips_time_to_live: "Your order is valid for a specified period known as Time-To-Live (TTL) and will expire automatically. Use this value to avoid canceling orders explicitly to save yourself some EXP. We recommend using amount between one hour and one day.",
    tips_pex_fee: "The total fee in PEX to pay ring-miners to find counterparty orders that your order can trade with. The higher the fee is, the more likely and quicker your order will be matched and filled.",
    ...
    custom_pex_fee_title:'Adjust Trading Fee',
    ...
    current_pex_fee_ratio:'PEX Fee Ratio',
    current_pex_fee: 'PEX Fee',
  ...
  token: {
    ...
    view_transaction: 'View Transaction on EXPscan.io',
  ...
  wallet: {
    ...
    loopring_on: "EXPEX token on  {project}",
    neo: "NEO",
    qtum: "QTUM",
